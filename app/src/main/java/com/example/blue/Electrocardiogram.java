...
public class Electrocardiogram extends View {
    ...
    private void init() {
      ...
      // electrocarPaint.setFilterBitmap(true);
...
private void drawElectrocardiogram(Canvas canvas) {
    gap=gap*num3;
    Log.e(TAG,gap + "GGGGGGGGGGGGGGGGGGG");
  if(ClentSendActivity.i ==0)
   ...
   /*         if(draw_data == 1)
            ...
            electrocarPath.lineTo(last_x+gap, electrocardDatas.get(ClentSendActivity.i-1));
            last_x=last_x+gap;
          if(draw_data == 1)
            {
